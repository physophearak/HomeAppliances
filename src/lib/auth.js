...
export const PERMISSIONS = {
  owner: { addProduct: true, adjustStock: true, editExchangeRate: true, manageConnection: true },
  staff: { addProduct: false, adjustStock: false, editExchangeRate: false, manageConnection: false },
}
